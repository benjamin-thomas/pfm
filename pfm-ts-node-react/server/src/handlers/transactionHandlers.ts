...
export const getMany = async (req: http.IncomingMessage, res: http.ServerResponse, repo: TransactionRepo): Promise<void> => {
...
export const getOne = async (req: http.IncomingMessage, res: http.ServerResponse, repo: TransactionRepo, id: number): Promise<void> => {
...
export const create = async (req: http.IncomingMessage, res: http.ServerResponse, repo: TransactionRepo): Promise<void> => {
